...
### First step: read data into R and roughly check on dimensions and str
...
#### Ideal case, I would love to do k-fold but to save time, I simply used training/verfication split introduced in class, where 80% was training, 20% was verification
...
```
### output suggested only 12 parameter needed to represent 80%
```{r simple fit}
start<-proc.time()
start 
...
#this training takes roughly 20 minutes
...
confusionMat
```
# Uing 80% of variation through PCA, accuracy is 0.9882
